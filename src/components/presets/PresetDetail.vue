            ...
            <div class="flex-1 overflow-y-auto">
                <div class="p-6 space-y-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-yellow-700 mt-1">
                                    This preset will override
                                    {{ conflicts.length }} of your current
                                    settings.
                                </p>
                            </div>
                        </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p class="text-xs text-gray-600">
                                        {{ domainSettings.length }} settings
                                    </p>
                                </div>
                                <div class="divide-y divide-gray-200">
                                    <div
                                        v-for="setting in domainSettings.slice(
                                            0,
                                            showAllSettings[domain]
                                                ? undefined
                                                : 3,
                                        )"
                                        :key="setting.key"
                                ...
                                >
                                    ...
                                    >
                                        {{
                                            showAllSettings[domain]
                                                ? "Show less"
                                                : `Show ${domainSettings.length - 3} more`
                                        }}
                                    </button>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <pre
                                class="bg-gray-900 text-gray-100 p-4 rounded-lg text-xs overflow-x-auto max-h-64 overflow-y-auto font-mono"
                                >{{
                                    preset?.content || "No content available"
                                }}</pre
                            >
                            <button
                                @click="copyContent"
...
import {
    getDomainFromSettingId,
    parseSettingId,
    buildSettingId,
} from "../../utils/settingId.js";
...
const groupedSettings = computed(() => {
    ...
    Object.entries(props.preset.settings).forEach(([settingId, value]) => {
        try {
            const { domain, key } = parseSettingId(settingId);
